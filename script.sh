...
sudo echo student1:helloworld| chpasswd
echo "student1:helloworld| chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:s2-passw0rd | chpasswd
echo "student2:s2-passw0rd | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:t3-passw0rd | chpasswd
echo "teacher3:t3-passw0rd| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:t4-passw0rd | chpasswd
echo "teacher4:t4-passw0rd| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:helloworld | chpasswd
echo "other5:helloworld| chpasswd"
...
sudo touch personal/dummy.file
echo "touch personal/dummy.file"

sudo chown student1 ./personal/dummy.file
echo "chown student1 ./personal/dummy.file"

sudo chgrp student1 ./personal/dummy.file
echo "chgrp student1 ./personal/dummy.file"
...
sudo touch shared/dummy.file
echo "touch shared/dummy.file"

sudo chown student1 ./shared/dummy.file
echo "chown student1 ./shared/dummy.file"

sudo chgrp student1 ./shared/dummy.file
echo "chgrp teacher ./shared/dummy.file"

sudo chmod 750 ./shared/dummy.file
echo "chmod 750 ./shared/dummy.file"
...
sudo chown student2 ./personal/dummy.file
echo "chown student2 ./personal/dummy.file"

sudo chgrp student2 ./personal/dummy.file
echo "chgrp student2 ./personal/dummy.file"
...
sudo chown student2 ./shared/dummy.file
echo "chown student2 ./shared/dummy.file"

sudo chgrp student2 ./shared/dummy.file
echo "chgrp teacher ./shared/dummy.file"
...
sudo touch security/dummy.file
echo "touch security/dummy.file"

sudo chown teacher3 ./security/dummy.file
echo "chown teacher3 ./security/dummy.file"

sudo chgrp teacher3 ./security/dummy.file
echo "chgrp teacher3 ./security/dummy.file"
...
sudo touch security/lectures/dummy.file
echo "touch security/lectures/dummy.file"

sudo chown teacher3 ./security/lectures/dummy.file
echo "chown teacher3 ./security/lectures/dummy.file"

sudo chgrp teacher ./security/lectures/dummy.file
echo "chgrp teacher ./security/lectures/dummy.file"

sudo chmod 750 ./security/lectures/dummy.file
echo "sudo chmod 750 ./security/lectures/dummy.file"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/dummy.file
echo "touch personal/dummy.file"

sudo chown teacher3 ./security/exam/dummy.file
echo "chown teacher3 .security/exam/dummy.file"

sudo chgrp teacher3 ./security/exam/dummy.file
echo "chgrp teacher3 .security/exam/dummy.file"
...
sudo chmod -R 700 ./security/exam/dummy.file
echo "chmod -R 700 ./security/exam/dummy.file"
...
sudo chown teacher4 ./personal/dummy.file
echo "chown teacher4 .personal/dummy.file"

sudo chgrp teacher4 ./personal/dummy.file
echo "chgrp teacher4 .personal/dummy.file"
...
sudo chmod -R 700 ./personal/dummy.file
echo "chmod -R 700 ./personal/dummy.file"

sudo mkdir network
echo "mkdir network"

sudo touch network/dummy.file
echo "touch network/dummy.file"

sudo chown teacher4 ./network/dummy.file
echo "chown teacher4 .network/dummy.file"

sudo chgrp teacher4 ./network/dummy.file
echo "chgrp teacher4 .network/dummy.file"
...
sudo chmod -R 777 ./network/dummy.file
echo "chmod -R 766 ./network/dummy.file"
