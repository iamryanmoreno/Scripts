...
sudo echo student1:s1-pass | chpasswd
echo "student1:s1-pass| chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:compsame | chpasswd
echo "student2:compsame | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:t3-pass | chpasswd
echo "teacher3:t3-pass| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:compsame | chpasswd
echo "teacher4:compsame| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:o5-pass | chpasswd
echo "other5:o5-pass| chpasswd"
...
sudo touch personal/anything.txt
echo "touch personal/anything.txt"

sudo chown student1 ./personal/anything.txt
echo "chown student1 ./personal/anything.txt"

sudo chgrp student1 ./personal/anything.txt
echo "chgrp student1 ./personal/anything.txt"
...
sudo touch shared/anything.txt
echo "touch shared/anything.txt"

sudo chown student1 ./shared/anything.txt
echo "chown student1 ./shared/anything.txt"

sudo chgrp student1 ./shared/anything.txt
echo "chgrp teacher ./shared/anything.txt"

sudo chmod 750 ./shared/anything.txt
echo "chmod 750 ./shared/anything.txt"
...
sudo chown student2 ./personal/anything.txt
echo "chown student2 ./personal/anything.txt"

sudo chgrp student2 ./personal/anything.txt
echo "chgrp student2 ./personal/anything.txt"
...
sudo chown student2 ./shared/anything.txt
echo "chown student2 ./shared/anything.txt"

sudo chgrp student2 ./shared/anything.txt
echo "chgrp teacher ./shared/anything.txt"
...
sudo touch security/anything.txt
echo "touch security/anything.txt"

sudo chown teacher3 ./security/anything.txt
echo "chown teacher3 ./security/anything.txt"

sudo chgrp teacher3 ./security/anything.txt
echo "chgrp teacher3 ./security/anything.txt"
...
sudo touch security/lectures/anything.txt
echo "touch security/lectures/anything.txt"

sudo chown teacher3 ./security/lectures/anything.txt
echo "chown teacher3 ./security/lectures/anything.txt"

sudo chgrp teacher ./security/lectures/anything.txt
echo "chgrp teacher ./security/lectures/anything.txt"

sudo chmod 750 ./security/lectures/anything.txt
echo "sudo chmod 750 ./security/lectures/anything.txt"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/anything.txt
echo "touch personal/anything.txt"

sudo chown teacher3 ./security/exam/anything.txt
echo "chown teacher3 .security/exam/anything.txt"

sudo chgrp teacher3 ./security/exam/anything.txt
echo "chgrp teacher3 .security/exam/anything.txt"
...
sudo chmod -R 700 ./security/exam/anything.txt
echo "chmod -R 700 ./security/exam/anything.txt"
...
sudo chown teacher4 ./personal/anything.txt
echo "chown teacher4 .personal/anything.txt"

sudo chgrp teacher4 ./personal/anything.txt
echo "chgrp teacher4 .personal/anything.txt"
...
sudo chmod -R 700 ./personal/anything.txt
echo "chmod -R 700 ./personal/anything.txt"

sudo mkdir network
echo "mkdir network"

sudo touch network/anything.txt
echo "touch network/anything.txt"

sudo chown teacher4 ./network/anything.txt
echo "chown teacher4 .network/anything.txt"

sudo chgrp teacher4 ./network/anything.txt
echo "chgrp teacher4 .network/anything.txt"
...
sudo chmod -R 777 ./network/anything.txt
echo "chmod -R 766 ./network/anything.txt"
