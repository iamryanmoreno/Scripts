...
sudo echo student1:same_password | chpasswd
echo "student1:same_password| chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:2-pass-word | chpasswd
echo "student2:2-pass-word | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:3-pass-word | chpasswd
echo "teacher3:3-pass-word| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:4-pass-word | chpasswd
echo "teacher4:4-pass-word| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:same_password | chpasswd
echo "other5:same_password| chpasswd"
...
sudo touch personal/file1.doc
echo "touch personal/file1.doc"

sudo chown student1 ./personal/file1.doc
echo "chown student1 ./personal/file1.doc"

sudo chgrp student1 ./personal/file1.doc
echo "chgrp student1 ./personal/file1.doc"
...
sudo touch shared/file1.doc
echo "touch shared/file1.doc"

sudo chown student1 ./shared/file1.doc
echo "chown student1 ./shared/file1.doc"

sudo chgrp student1 ./shared/file1.doc
echo "chgrp teacher ./shared/file1.doc"

sudo chmod 750 ./shared/file1.doc
echo "chmod 750 ./shared/file1.doc"
...
sudo chown student2 ./personal/file1.doc
echo "chown student2 ./personal/file1.doc"

sudo chgrp student2 ./personal/file1.doc
echo "chgrp student2 ./personal/file1.doc"
...
sudo chown student2 ./shared/file1.doc
echo "chown student2 ./shared/file1.doc"

sudo chgrp student2 ./shared/file1.doc
echo "chgrp teacher ./shared/file1.doc"
...
sudo touch security/file1.doc
echo "touch security/file1.doc"

sudo chown teacher3 ./security/file1.doc
echo "chown teacher3 ./security/file1.doc"

sudo chgrp teacher3 ./security/file1.doc
echo "chgrp teacher3 ./security/file1.doc"
...
sudo touch security/lectures/file1.doc
echo "touch security/lectures/file1.doc"

sudo chown teacher3 ./security/lectures/file1.doc
echo "chown teacher3 ./security/lectures/file1.doc"

sudo chgrp teacher ./security/lectures/file1.doc
echo "chgrp teacher ./security/lectures/file1.doc"

sudo chmod 750 ./security/lectures/file1.doc
echo "sudo chmod 750 ./security/lectures/file1.doc"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/file1.doc
echo "touch personal/file1.doc"

sudo chown teacher3 ./security/exam/file1.doc
echo "chown teacher3 .security/exam/file1.doc"

sudo chgrp teacher3 ./security/exam/file1.doc
echo "chgrp teacher3 .security/exam/file1.doc"
...
sudo chmod -R 700 ./security/exam/file1.doc
echo "chmod -R 700 ./security/exam/file1.doc"
...
sudo chown teacher4 ./personal/file1.doc
echo "chown teacher4 .personal/file1.doc"

sudo chgrp teacher4 ./personal/file1.doc
echo "chgrp teacher4 .personal/file1.doc"
...
sudo chmod -R 700 ./personal/file1.doc
echo "chmod -R 700 ./personal/file1.doc"

sudo mkdir network
echo "mkdir network"

sudo touch network/file1.doc
echo "touch network/file1.doc"

sudo chown teacher4 ./network/file1.doc
echo "chown teacher4 .network/file1.doc"

sudo chgrp teacher4 ./network/file1.doc
echo "chgrp teacher4 .network/file1.doc"
...
sudo chmod -R 777 ./network/file1.doc
echo "chmod -R 766 ./network/file1.doc"
