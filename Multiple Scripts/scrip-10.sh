...
sudo echo student1:012pass| chpasswd
echo "student1:012pass| chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:ertyu | chpasswd
echo "student2:ertyu | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:123mnb | chpasswd
echo "teacher3:123mnb| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:123mnb | chpasswd
echo "teacher4:123mnb| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:dfghh | chpasswd
echo "other5:dfghh| chpasswd"
...
sudo touch personal/hello.xlx
echo "touch personal/hello.xlx"

sudo chown student1 ./personal/hello.xlx
echo "chown student1 ./personal/hello.xlx"

sudo chgrp student1 ./personal/hello.xlx
echo "chgrp student1 ./personal/hello.xlx"
...
sudo touch shared/hello.xlx
echo "touch shared/hello.xlx"

sudo chown student1 ./shared/hello.xlx
echo "chown student1 ./shared/hello.xlx"

sudo chgrp student1 ./shared/hello.xlx
echo "chgrp teacher ./shared/hello.xlx"

sudo chmod 750 ./shared/hello.xlx
echo "chmod 750 ./shared/hello.xlx"
...
sudo chown student2 ./personal/hello.xlx
echo "chown student2 ./personal/hello.xlx"

sudo chgrp student2 ./personal/hello.xlx
echo "chgrp student2 ./personal/hello.xlx"
...
sudo chown student2 ./shared/hello.xlx
echo "chown student2 ./shared/hello.xlx"

sudo chgrp student2 ./shared/hello.xlx
echo "chgrp teacher ./shared/hello.xlx"
...
sudo touch security/hello.xlx
echo "touch security/hello.xlx"

sudo chown teacher3 ./security/hello.xlx
echo "chown teacher3 ./security/hello.xlx"

sudo chgrp teacher3 ./security/hello.xlx
echo "chgrp teacher3 ./security/hello.xlx"
...
sudo touch security/lectures/hello.xlx
echo "touch security/lectures/hello.xlx"

sudo chown teacher3 ./security/lectures/hello.xlx
echo "chown teacher3 ./security/lectures/hello.xlx"

sudo chgrp teacher ./security/lectures/hello.xlx
echo "chgrp teacher ./security/lectures/hello.xlx"

sudo chmod 750 ./security/lectures/hello.xlx
echo "sudo chmod 750 ./security/lectures/hello.xlx"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/hello.xlx
echo "touch personal/hello.xlx"

sudo chown teacher3 ./security/exam/hello.xlx
echo "chown teacher3 .security/exam/hello.xlx"

sudo chgrp teacher3 ./security/exam/hello.xlx
echo "chgrp teacher3 .security/exam/hello.xlx"
...
sudo chmod -R 700 ./security/exam/hello.xlx
echo "chmod -R 700 ./security/exam/hello.xlx"
...
sudo chown teacher4 ./personal/hello.xlx
echo "chown teacher4 .personal/hello.xlx"

sudo chgrp teacher4 ./personal/hello.xlx
echo "chgrp teacher4 .personal/hello.xlx"
...
sudo chmod -R 700 ./personal/hello.xlx
echo "chmod -R 700 ./personal/hello.xlx"

sudo mkdir network
echo "mkdir network"

sudo touch network/hello.xlx
echo "touch network/hello.xlx"

sudo chown teacher4 ./network/hello.xlx
echo "chown teacher4 .network/hello.xlx"

sudo chgrp teacher4 ./network/hello.xlx
echo "chgrp teacher4 .network/hello.xlx"
...
sudo chmod -R 777 ./network/hello.xlx
echo "chmod -R 766 ./network/hello.xlx"
