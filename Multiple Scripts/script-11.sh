...
sudo echo student1:h45459| chpasswd
echo "student1:h45459| chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:dbfjfe8 | chpasswd
echo "student2:dbfjfe8 | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:efhbwiu8 | chpasswd
echo "teacher3:efhbwiu8| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:myP@ssw0rd | chpasswd
echo "teacher4:myP@ssw0rd| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:myP@ssw0rd | chpasswd
echo "other5:myP@ssw0rd| chpasswd"
...
sudo touch personal/mydocs.docx
echo "touch personal/mydocs.docx"

sudo chown student1 ./personal/mydocs.docx
echo "chown student1 ./personal/mydocs.docx"

sudo chgrp student1 ./personal/mydocs.docx
echo "chgrp student1 ./personal/mydocs.docx"
...
sudo touch shared/mydocs.docx
echo "touch shared/mydocs.docx"

sudo chown student1 ./shared/mydocs.docx
echo "chown student1 ./shared/mydocs.docx"

sudo chgrp student1 ./shared/mydocs.docx
echo "chgrp teacher ./shared/mydocs.docx"

sudo chmod 750 ./shared/mydocs.docx
echo "chmod 750 ./shared/mydocs.docx"
...
sudo chown student2 ./personal/mydocs.docx
echo "chown student2 ./personal/mydocs.docx"

sudo chgrp student2 ./personal/mydocs.docx
echo "chgrp student2 ./personal/mydocs.docx"
...
sudo chown student2 ./shared/mydocs.docx
echo "chown student2 ./shared/mydocs.docx"

sudo chgrp student2 ./shared/mydocs.docx
echo "chgrp teacher ./shared/mydocs.docx"
...
sudo touch security/mydocs.docx
echo "touch security/mydocs.docx"

sudo chown teacher3 ./security/mydocs.docx
echo "chown teacher3 ./security/mydocs.docx"

sudo chgrp teacher3 ./security/mydocs.docx
echo "chgrp teacher3 ./security/mydocs.docx"
...
sudo touch security/lectures/mydocs.docx
echo "touch security/lectures/mydocs.docx"

sudo chown teacher3 ./security/lectures/mydocs.docx
echo "chown teacher3 ./security/lectures/mydocs.docx"

sudo chgrp teacher ./security/lectures/mydocs.docx
echo "chgrp teacher ./security/lectures/mydocs.docx"

sudo chmod 750 ./security/lectures/mydocs.docx
echo "sudo chmod 750 ./security/lectures/mydocs.docx"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/mydocs.docx
echo "touch personal/mydocs.docx"

sudo chown teacher3 ./security/exam/mydocs.docx
echo "chown teacher3 .security/exam/mydocs.docx"

sudo chgrp teacher3 ./security/exam/mydocs.docx
echo "chgrp teacher3 .security/exam/mydocs.docx"
...
sudo chmod -R 700 ./security/exam/mydocs.docx
echo "chmod -R 700 ./security/exam/mydocs.docx"
...
sudo chown teacher4 ./personal/mydocs.docx
echo "chown teacher4 .personal/mydocs.docx"

sudo chgrp teacher4 ./personal/mydocs.docx
echo "chgrp teacher4 .personal/mydocs.docx"
...
sudo chmod -R 700 ./personal/mydocs.docx
echo "chmod -R 700 ./personal/mydocs.docx"

sudo mkdir network
echo "mkdir network"

sudo touch network/mydocs.docx
echo "touch network/mydocs.docx"

sudo chown teacher4 ./network/mydocs.docx
echo "chown teacher4 .network/mydocs.docx"

sudo chgrp teacher4 ./network/mydocs.docx
echo "chgrp teacher4 .network/mydocs.docx"
...
sudo chmod -R 777 ./network/mydocs.docx
echo "chmod -R 766 ./network/mydocs.docx"
