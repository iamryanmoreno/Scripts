...
sudo echo student1:passw0rd | chpasswd
echo "student1:passw0rd | chpasswd"

sudo useradd -m student2
echo "useradd -m student2"
sudo echo student2:passw0rd | chpasswd
echo "student2:passw0rd | chpasswd"

sudo useradd -m teacher3
echo "useradd -m teacher3"
sudo echo teacher3:pass3 | chpasswd
echo "teacher3:pass3| chpasswd"

sudo useradd -m teacher4
echo "useradd -m teacher4"
sudo echo teacher4:pass4 | chpasswd
echo "teacher4:pass4| chpasswd"

sudo useradd -m other5
echo "useradd -m other5"
sudo echo other5:pass5 | chpasswd
echo "other5:pass5| chpasswd"
...
sudo touch personal/empty.txt
echo "touch personal/empty.txt"

sudo chown student1 ./personal/empty.txt
echo "chown student1 ./personal/empty.txt"

sudo chgrp student1 ./personal/empty.txt
echo "chgrp student1 ./personal/empty.txt"
...
sudo touch shared/empty.txt
echo "touch shared/empty.txt"

sudo chown student1 ./shared/empty.txt
echo "chown student1 ./shared/empty.txt"

sudo chgrp student1 ./shared/empty.txt
echo "chgrp teacher ./shared/empty.txt"

sudo chmod 750 ./shared/empty.txt
echo "chmod 750 ./shared/empty.txt"
...
sudo chown student2 ./personal/empty.txt
echo "chown student2 ./personal/empty.txt"

sudo chgrp student2 ./personal/empty.txt
echo "chgrp student2 ./personal/empty.txt"
...
sudo chown student2 ./shared/empty.txt
echo "chown student2 ./shared/empty.txt"

sudo chgrp student2 ./shared/empty.txt
echo "chgrp teacher ./shared/empty.txt"
...
sudo touch security/empty.txt
echo "touch security/empty.txt"

sudo chown teacher3 ./security/empty.txt
echo "chown teacher3 ./security/empty.txt"

sudo chgrp teacher3 ./security/empty.txt
echo "chgrp teacher3 ./security/empty.txt"
...
sudo touch security/lectures/empty.txt
echo "touch security/lectures/empty.txt"

sudo chown teacher3 ./security/lectures/empty.txt
echo "chown teacher3 ./security/lectures/empty.txt"

sudo chgrp teacher ./security/lectures/empty.txt
echo "chgrp teacher ./security/lectures/empty.txt"

sudo chmod 750 ./security/lectures/empty.txt
echo "sudo chmod 750 ./security/lectures/empty.txt"

sudo mkdir security/exam
echo "mkdir security/exam"

sudo touch security/exam/empty.txt
echo "touch personal/empty.txt"

sudo chown teacher3 ./security/exam/empty.txt
echo "chown teacher3 .security/exam/empty.txt"

sudo chgrp teacher3 ./security/exam/empty.txt
echo "chgrp teacher3 .security/exam/empty.txt"
...
sudo chmod -R 700 ./security/exam/empty.txt
echo "chmod -R 700 ./security/exam/empty.txt"
...
sudo chown teacher4 ./personal/empty.txt
echo "chown teacher4 .personal/empty.txt"

sudo chgrp teacher4 ./personal/empty.txt
echo "chgrp teacher4 .personal/empty.txt"
...
sudo chmod -R 700 ./personal/empty.txt
echo "chmod -R 700 ./personal/empty.txt"

sudo mkdir network
echo "mkdir network"

sudo touch network/empty.txt
echo "touch network/empty.txt"

sudo chown teacher4 ./network/empty.txt
echo "chown teacher4 .network/empty.txt"

sudo chgrp teacher4 ./network/empty.txt
echo "chgrp teacher4 .network/empty.txt"
...
sudo chmod -R 777 ./network/empty.txt
echo "chmod -R 766 ./network/empty.txt"
